...
// fin suppValPoss
 ...
 // fin initPossibles
     ...
     *                s'il y en a, sinon, le premier trou tel que nbValPoss[i][j]==2 
     *                sinon le premier trou tel que nbValPoss[i][j]==3
     *                sinon le premier trou de gOrdi dans l'ordre des lignes
     * 
     */
        ...
        if (nbValPoss[trou[0]][trou[1]]<=3){
            ...
            while (trouve == false){
                ...
                if (nbValPoss[trou[0]][trou[1]]==1){
                    ...
                    System.out.println("Le valeur à la case " + trou[0]+1 + "," + trou[1]+1 + " est " + i + "?");
                    String exact = Ut.lireProchainMot();
                    if (exact.equals("non")){
                        pena++;
                        nbValPoss[trou[0]][trou[1]]--;
                        valPossibles[trou[0]][trou[1]][i]=false;
                    }      
                    else{
                        trouve = true;
                        gOrdi[trou[0]][trou[1]]=i;
